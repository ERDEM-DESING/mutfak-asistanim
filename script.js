...
function tatliOner() {
    const tatlilar = ["Sütlaç", "Baklava", "Künefe", "Magnolia", "Güllaç", "Kazandibi", "Şekerpare", "Fırın Sütlaç", "Kazandibi", "Kıbrıs Tatlısı", "Şekerpare", "Sufle", "Profiterol", "Kabak Tatlısı", "Ayva Tatlısı", "Revani", "Trileçe"];
